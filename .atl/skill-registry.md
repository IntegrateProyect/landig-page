# Skill Registry — sentinel-ai-landing-page
...
### branch-pr
- Path: /home/jh532004/.config/opencode/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/jh532004/.config/opencode/skills/chained-pr/SKILL.md
...
- Path: /home/jh532004/.config/opencode/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/jh532004/.config/opencode/skills/comment-writer/SKILL.md
...
### go-testing
- Path: /home/jh532004/.config/opencode/skills/go-testing/SKILL.md
...
### issue-creation
- Path: /home/jh532004/.config/opencode/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /home/jh532004/.config/opencode/skills/judgment-day/SKILL.md
...
### nextjs-15
- Path: /home/jh532004/.config/opencode/skills/nextjs-15/SKILL.md
- Trigger: >
- Rules:
...
### react-19
- Path: /home/jh532004/.config/opencode/skills/react-19/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: /home/jh532004/.config/opencode/skills/skill-creator/SKILL.md
...
### tailwind-4
- Path: /home/jh532004/.config/opencode/skills/tailwind-4/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### typescript
- Path: /home/jh532004/.config/opencode/skills/typescript/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: /home/jh532004/.config/opencode/skills/work-unit-commits/SKILL.md
...
### zod-4
- Path: /home/jh532004/.config/opencode/skills/zod-4/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### zustand-5
- Path: /home/jh532004/.config/opencode/skills/zustand-5/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.
